...
The `viewlint/recommended` configuration ensures that all the rules marked as recommended on the [rules reference page](/docs/rules-reference) will be enabled. You can configure rules individually by defining a new rules key, as in this example:
