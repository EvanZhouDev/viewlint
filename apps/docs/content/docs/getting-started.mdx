...
ViewLint uses Playwright under the hood, and Playwright does not ship browser binaries in the package itself.
If you do not have a Playwright browser available, install a browser instance before running ViewLint, with your preferred package manager:
